...
class YAMLLoader:
    ...
    def _create_test_suite(data: Dict[str, Any]) -> TestSuite:
        ...
        test_suite = TestSuite(
            ...
            default_environment=Environment(data.get('default_environment', 'development')),
    ...
    def _create_test_case(test_data: Dict[str, Any], suite_data: Dict[str, Any]) -> TestCase:
        ...
        test_case = TestCase(
            ...
            environment=Environment(test_data.get('environment', suite_data.get('default_environment', 'development'))),
            browser=browser,
    ...
    def _test_suite_to_dict(test_suite: TestSuite) -> Dict[str, Any]:
        ...
        return {
            ...
            'default_environment': test_suite.default_environment.value,
            'default_browser': {
            ...
            'tests': [
                {
                    ...
                    'tags': test.tags,
                    'environment': test.environment.value,
                    'browser': {
